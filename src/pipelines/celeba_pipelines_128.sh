...
# Encoder pipeline:
# CUDA_VISIBLE_DEVICES=0 ./celeba_pipelines_128.sh encoder \
...
# Classifier pipeline:
# ./celeba_pipelines_128.sh classifier "0.1,0.25,0.5..." \
#   --fair_encoder_name "fair_encoder/gen_model=glow_celeba_128/..." \
...
encoder)
  ...
  python encoder_pipeline.py \
    ...
    --dataset glow_celeba_128_latent_lmdb --input_representation latent --image_size 128 --n_bits 5 \
    ...
    --sampling_batch_size 2000 --certification_batch_size 64 --skip 64 --split test \
    "$@"
  ;;
